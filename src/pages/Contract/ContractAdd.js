...
import {LeftOutlined, PlusOutlined, SnippetsOutlined, TableOutlined, PlusCircleOutlined} from "@ant-design/icons";
import {
    columnsAcc,
    columnsExp,
    dataSmetaAccFilter,
...
const ContractAdd = () => {
    ...
    const showGraph = () => {
        ...
        console.log(specData,'specDataasasd')
    ...
    const handleCreate = () => {
        ...
        form
            .validateFields()
            .then(async (values) => {
                values["dateContr"] = dates.dateContr
                values["dateBegin"] = dates.dateBegin
                values["dateEnd"] = dates.dateEnd
                values["dateAvans"] = dates.dateAvans
                values["specifications"] = formSpec
                values["graphics"] = formGraph
                values["docType"] = 0
    ...
    const saveTemplate = () => {
        ...
        formTemplate["dateContr"] = dates.dateContr
        formTemplate["dateBegin"] = dates.dateBegin
        formTemplate["dateEnd"] = dates.dateEnd
        formTemplate["dateAvans"] = dates.dateAvans
        formTemplate["specifications"] = formSpec
        formTemplate["graphics"] = formGraph
        formTemplate["docType"] = 0

        formTemplate["regDate"] = '12.12.2099'
        formTemplate["regNumb"] = 'XXXXXX'

        formTemplate["nds"] = formTemplate["sumNds"]

        delete formTemplate.sumNds
...
//        setAccCode(res)
    ...
    const getDataByTemplate = async (data) => {
        ...
        changeDateFormat(data.dateAvans, data.dateAvans, 'dateAvans')
        changeDateFormat(data.dateBegin, data.dateBegin, 'dateBegin')
        changeDateFormat(data.dateEnd, data.dateEnd, 'dateEnd')
        changeDateFormat(data.dateContr, data.dateContr, 'dateContr')
    };
    ...
    return (
        <>
            ...
            <div style={{display:"flex", flexDirection:"row", gap:"10px", height:"64px", justifyContent: "left", alignItems:"center", padding:"12px"}}>
                <h3><Button shape="circle" icon={<LeftOutlined />}  style={{fontSize:'14px',marginRight:"10px"}} onClick={handleFormExit}/>Шартнома яратиш</h3>
            </div>
                    ...
                    <Col span={24}>
                        ...
                        <div style={{display:"flex", flexDirection:"row", gap:"10px", height:"50px", justifyContent: "space-between", alignItems:"center", paddingLeft:"30px"}}>
                            ...
                            <div style={{display:"flex", gap:"10px"}}>
                                ...
                                >
                                    <CNSpecification specifications={specData} setSpecData={setSpecData} setGraphData={setGraphData} smetaData={smetaData} />
                            ...
                            <div style={{display:"flex", gap:"10px"}}>
                                ...
                                <DocumentTemplateSave documentType="CONTRACT" handleSaveTemplate={saveTemplate}/>

                                <DocumentTemplate documentType="CONTRACT" handleLoadDocument={getDataByTemplate}/>
