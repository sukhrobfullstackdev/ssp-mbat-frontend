...
const RefTerritoryTab = ({setTitleNav}) => {
    ...
    useEffect(() => {
        setTitleNav('Худудлар маълумотномаси');
    }, []);
    ...
    const getTabData = async (filter = '') => {
        ...
        dataTerritoryRef.query['filters'] = filters;
        ...
        <Layout style={{height:"100%", overflow:"hidden"}}>
            ...
            <div>
                ...
                >
                    ...
                    <Column title="Юкори худуд" dataIndex="parent" key="parent" width={100}></Column>
                    <Column title="Тури" dataIndex="type" key="type" width={100}></Column>
                    <Column title="Холати" dataIndex="state" key="state" width={100}></Column>
...
export default RefTerritoryTab