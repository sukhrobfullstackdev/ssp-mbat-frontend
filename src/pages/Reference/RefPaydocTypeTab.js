...
const dataPaydocTypeRef = {
    "query": {
        "id": "PAYDOC_TYPE_REF",
        "source": "PAYDOC_TYPE_REF",
        "fields": [
...
const RefPaydocTypeTab = ({setTitleNav}) => {
    ...
    useEffect(() => {
        setTitleNav('Тулов хужжати турлари маълумотномаси');
    }, []);
    ...
    const getTabData = async (filter = '') => {
        ...
        dataPaydocTypeRef.query['filters'] = filters;
...
export default RefPaydocTypeTab