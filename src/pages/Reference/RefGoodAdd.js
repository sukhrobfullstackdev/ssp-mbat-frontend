...
const RefGood = () => {
    ...
    const handleChangeUnit = (value, rec) => {
        form.setFieldValue('unit', rec.label)
    };
                                ...
                                >
                                    <Space direction="vertical" size="small">
                                        ...
                                        <Space direction="horizontal" size="small">
                                            ...
                                            <Form.Item name="code" label="Коди" rules={[{required: false, message:'Номини киритинг!'}]}>
                                                <NumberInputBM
                                                    style={{ width: 250 }}
                                                    maxLength={30}
                                                />
                                            ...
                                            <Form.Item name="barCode" label="Бар коди" rules={[{required: false, message:'Бар кодини киритинг!'}]}>
                                                <NumberInputBM
                                                    style={{ width: 250 }}
                                                    maxLength={20}
                                                />
                                        ...
                                        <Space direction="horizontal" size="small">
                                            ...
                                            <Form.Item name="ikpuCode" label="ИКПУ коди" rules={[{required: false, message:'ИКПУ кодини киритинг!'}]}>
                                                <NumberInputBM
                                                    style={{ width: 250 }}
                                                    maxLength={30}
                                                />
                                            ...
                                            <Form.Item name="tnvedCode" label="ТНВЕД коди" rules={[{required: false, message:'ТНВЕД кодини киритинг!'}]}>
                                                <NumberInputBM
                                                    style={{ width: 250 }}
                                                    maxLength={30}
                                                />
                                        ...
                                        <Space direction="horizontal" size="small">
                                            ...
                                            <Form.Item name="unitId" label="Улчов бирлиги" rules={[{required: true, message:'Улчов бирлигини танланг!'}]}>
                                            ...
                                            <Form.Item hidden={true} name="unit" label="Улчов бирлиги номи" rules={[{required: false, message:'Улчов бирлиги номини киритинг!'}]}>
                                                <Input/>
                                            </Form.Item>
