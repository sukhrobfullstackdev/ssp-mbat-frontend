...
import {dataTab as dataVendorSprTab, dataFilter as dataVendorSprFilter, columnsVendor as columnsVendorSpr} from "./VendorData"
...
const VendorEdit = () => {
    ...
    const handleCreate = () => {
        ...
        form
            .validateFields()
            .then(async (values) => {
                values.govRegDate = values.govRegDate.format('DD.MM.YYYY');
                values["name"] = values["vendorName"]
                values["bankAccounts"] = specData.bankAcc ? specData.bankAcc : vendor.bankAccounts
...
//        setAccCode(res)
    ...
    const getById = async () => {
        const { data } = await axios.get(`/vendor/loadVendorById?id=${id}`,
            {
                headers: headers,
                //crossDomain: true,
                withCredentials: false
        ...
        form.setFieldsValue({
            ...
            govRegDate: moment(data.govRegDate, "DD.MM.YYYY"),
        })
    };
    ...
    return (
        <>
            ...
            <div style={{display:"flex", flexDirection:"row", gap:"10px", height:"64px", justifyContent: "left", alignItems:"center", padding:"12px"}}>
                <h3><Button shape="circle" icon={<LeftOutlined />}  style={{fontSize:'14px',marginRight:"10px"}} onClick={handleFormExit}/>Таъминотчини таҳрирлаш</h3>
            </div>
                ...
                <Row gutter={[16, 16]} style={{marginRight:'0',marginLeft:'0'}}>
                    ...
                    <Col span={24}>
                        ...
                        <div style={{display:"flex", flexDirection:"row", gap:"10px", height:"50px", justifyContent: "left", alignItems:"center", paddingLeft:"30px"}}>
                            ...
                            >
                                <VendorPoints bankAccounts={vendor.bankAccounts} setSpecData={setSpecData}/>
                            ...
                            <Space size={20} direction="horizontal" align="start" >
                                ...
                                >
                                    <Space direction="vertical" size="small">
                                            ...
                                            <Form.Item name="inn" onChange={changeInn} label="ИНН" rules={[{required: true, message:'ИНН ни киритинг!'}]}>
                                                <Input/>
                                            </Form.Item>
                                ...
                                >
                                    ...
                                    <Space direction="vertical">
                                        ...
                                        <Space direction="horizontal">
                                            ...
                                            <Form.Item name="postIndex" style={{width:150}} label="Почта индекси" rules={[{required: true, message:'Почта индексини киритинг!'}]}>
                                                <Input/>
                                            </Form.Item>

                                            <Form.Item name="phones" style={{width:150}} label="Тел. рақам" rules={[{required: true, message:'Тел. ракамни киритинг!'}]}>
                                                <Input/>
                                            </Form.Item>

                                            <Form.Item name="fax" style={{width:150}} label="Факс" rules={[{required: true, message:'Факсни киритинг!'}]}>
                                                <Input/>
                                            </Form.Item>
